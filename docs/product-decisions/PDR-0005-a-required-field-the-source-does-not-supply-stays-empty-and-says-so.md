...
from method prose on a card that had none — which is recorded separately as `OQ-37` and is NOT
decided here.
...
ingredient list derived from method prose (`OQ-37`), and whether the fields that are required and
