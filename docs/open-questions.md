...
| OQ-05 | hosting platform/reference deployment | closed by ADR-0023 (a scale-to-zero machine, a sleeping managed Postgres, a persistent volume — superseding ADR-0011's always-on rented server) |
